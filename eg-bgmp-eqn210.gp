\\ \r lfl3\eg-bgmp-eqn210.gp

read("lfl3\\kit-alpha1Variable.gp");

\\ this example comes from equation (2.10) in Bennett, Gyory, Mignotte and Pinter
\\ Comp. Math. (2006)
\\ for the diophantine equation 2^\alpha*x^n-7^\beta*y^n = \pm 1
...
\\ L=  85, m= 13.5000, rho(3logs)= 7.5000, chi= 0.9000, K=  307786.870*logX,
\\ nonDegen log|Lambda|>-5.271366 e7*logX, nonDegenNUB=5.271366 e7,
\\ rho(2logs)= 7.0000, mu(2logs)= 0.6100, degenNUB1=    0.e-19, degenNUB2=5.102216 e7, degenNUB3=1.039516 e8,
\\ nUB=5.271366 e7, eliminate-b2
eg210_check_it1()={
	...
	actMinNUB=eg210_search_general(bigL,bigL,m,m,rho3Logs,rho3Logs,chi,chi,rho2Logs,rho2Logs,mu,mu,,2);
	expMinNUB=52.71366*10^6;
	if(abs(actMinNUB/expMinNUB-1)>0.0001,
		printf("FAIL: eg210_check_it1(), actMinNUB=%9.6e, expMinNUB=%9.6e\n",actMinNUB,expMinNUB);
	);
}

\\ L=  59, m= 17.5000, rho(3logs)= 6.7500, chi= 1.2250, K=  222963.593*logX, nonDegen log|Lambda|>-2.511975 e7*logX,
\\ nonDegenNUB=2.511975 e7, rho(2logs)= 7.0000, mu(2logs)= 0.6100, degenNUB1=    0.e-19, degenNUB2=2.517349 e7,
\\ degenNUB3=5.116201 e7, nUB=2.517349 e7, eliminate-b2
eg210_check_it2()={
	...
	actMinNUB=eg210_search_general(bigL,bigL,m,m,rho3Logs,rho3Logs,chi,chi,rho2Logs,rho2Logs,mu,mu,nUB,2);
	expMinNUB=25.17349*10^6;
	if(abs(actMinNUB/expMinNUB-1)>0.0001,
		printf("FAIL: eg210_check_it2(), actMinNUB=%9.6e, expMinNUB=%9.6e\n",actMinNUB,expMinNUB);
	);
}

\\ L=  56, m= 16.5000, rho(3logs)= 7.0000, chi= 1.2600, K=  214922.489*logX, nonDegen log|Lambda|>-2.342031 e7*logX,
\\ nonDegenNUB=2.342031 e7, rho(2logs)= 7.0000, mu(2logs)= 0.6100, degenNUB1=    0.e-19, degenNUB2=2.334667 e7,
\\ degenNUB3=4.766744 e7, nUB=2.342031 e7, eliminate-b2
eg210_check_it3()={
	my(bigL,chi,m,mu,nUB,rho2Logs,rho3Logs);
	...
	actMinNUB=eg210_search_general(bigL,bigL,m,m,rho3Logs,rho3Logs,chi,chi,rho2Logs,rho2Logs,mu,mu,nUB,2);
	expMinNUB=23.42031*10^6;
	if(abs(actMinNUB/expMinNUB-1)>0.0001,
		printf("FAIL: eg210_check_it3(), actMinNUB=%9.6e, expMinNUB=%9.6e\n",actMinNUB,expMinNUB);
	);
}

eg210_search_it1(dbg=0)={
	...
	rho2LB=6;
	rho2UB=rho2LB+4;
	eg210_search_general(bigLLB,bigLUB,mLB,mUB,rho3LB,rho3UB,chiLB,chiUB,rho2LB,rho2UB,,,,dbg);
}

eg210_search_it2(nUBInit,dbg=0)={
	my(bigLLB,bigLUB,chiLB,chiUB,mLB,mUB,rho2LB,rho2UB,rho3LB,rho3UB);
	...
	rho2LB=5;
	rho2UB=rho2LB+5;
	eg210_search_general(bigLLB,bigLUB,mLB,mUB,rho3LB,rho3UB,chiLB,chiUB,rho2LB,rho2UB,,,nUBInit,dbg);
}

eg210_search_it3(nUBInit,dbg=0)={
	my(bigLLB,bigLUB,chiLB,chiUB,mLB,mUB,rho2LB,rho2UB,rho3LB,rho3UB);
...
eg210_search_general(bigLLB,bigLUB,mLB,mUB,rho3LB,rho3UB,chiLB,chiUB,rho2LB,rho2UB,muLB=0,muUB=0,nUBInit=0,dbg=0)={
	...
	if(nUBInit==0,
		...
		printf("nUBInit=%9.6e\n",nUBInit);
		printf("eg210_search_general(): calculated nUBInit=%9.6e\n",nUBInit);
	);
	minNUB=nUBInit;
